...
class SecurityPolicyForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "emergency_lockdown_message": forms.Textarea(attrs={"rows": 3}),
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["emergency_lockdown_enabled"].help_text = "Immediately block normal access for non-admin users until the incident is cleared."
        self.fields["emergency_lockdown_message"].help_text = "Optional message shown when access is paused. Leave blank to use the default warning."
